...
public class Oscillator : MonoBehaviour
{
    ...
    [SerializeField] Vector3 movement = new Vector3(0,2,1); // The movement vector that determines the direction and magnitude of movement
    ...
    void Update()
    {
        ...
        float movementFactor = Mathf.Sin(cycles * tau); // Calculate the raw sine wave value based on the number of cycles completed
